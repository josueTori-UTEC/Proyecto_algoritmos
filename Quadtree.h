...
public:
    Quadtree(Rectangle _boundary, int _capacity): boundary(_boundary), capacity(_capacity),northeast(nullptr), northwest(nullptr),southeast(nullptr), southwest(nullptr) {}
